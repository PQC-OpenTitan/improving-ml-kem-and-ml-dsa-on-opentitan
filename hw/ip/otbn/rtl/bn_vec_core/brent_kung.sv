  ...
  generate
    for (i = 0; i < 256; i++) begin
      if (i >= 31 && (i & 31) == 31) begin
        assign G5[i] = (word_mode != VecType_h16) ? (G4[i] | (P4[i] & G4[i-16])) : G4[i];
        assign P5[i] = (word_mode != VecType_h16) ? (P4[i] & P4[i-16])           : P4[i];
      end else begin
        assign G5[i] = G4[i];
        assign P5[i] = P4[i];
      end
  ...
  generate
    for (i = 0; i < 256; i++) begin
      if (i >= 63 && (i & 63) == 63) begin
        assign G6[i] = ((word_mode != VecType_h16) & (word_mode != VecType_s32)) ? (G5[i] | (P5[i] & G5[i-32])) : G5[i];
        assign P6[i] = ((word_mode != VecType_h16) & (word_mode != VecType_s32)) ? (P5[i] & P5[i-32])           : P5[i];
      end else begin
        assign G6[i] = G5[i];
        assign P6[i] = P5[i];
      end
  ...
  generate
    for (i = 0; i < 256; i++) begin
      if (i >= 127 && (i & 127) == 127) begin
        assign G7[i] = ((word_mode != VecType_h16) & (word_mode != VecType_s32) & (word_mode != VecType_d64)) ?
                        (G6[i] | (P6[i] & G6[i-64])) :
                        G6[i];
        assign P7[i] = ((word_mode != VecType_h16) & (word_mode != VecType_s32) & (word_mode != VecType_d64)) ?
                        (P6[i] & P6[i-64]) :
                        P6[i];
      end else begin
        assign G7[i] = G6[i];
